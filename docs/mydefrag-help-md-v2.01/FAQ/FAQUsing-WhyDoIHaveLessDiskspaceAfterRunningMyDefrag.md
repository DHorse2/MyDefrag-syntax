## FAQ Using - Why do I have less diskspace after running MyDefrag?

The diskspace is used by the Microsoft Shadow Copy service, and it happens with all defragmenters and optimizers, not only MyDefrag.
...
_Source HTML: `FAQ/FAQUsing-WhyDoIHaveLessDiskspaceAfterRunningMyDefrag.html`_
