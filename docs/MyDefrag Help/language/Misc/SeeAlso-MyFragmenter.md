...
MyFragmenter is a small commandline utility included with MyDefrag to
  fragment existing files, to generate new fragmented files with random data,
  or to list fragmentation information about files. It is useful only for
  people who are testing defragmentation programs.
