...
- The journal can also be deleted from the Windows Run commandline with the [![ \* ](../img/Bullit.gif)](http://technet2.microsoft.com/windowsserver2008/en/library/213d36d1-f4ba-4390-93be-72e23df03a671033.mspx?mfr=true) [**fsutil**](http://technet2.microsoft.com/windowsserver2008/en/library/213d36d1-f4ba-4390-93be-72e23df03a671033.mspx?mfr=true) command, in Windows 2003/XP/Vista, not Windows 2000. The "fsutil" command must be run as administrator and can take several minutes to finish. Example of the commandline:  
  |                                |
  |--------------------------------|
...
_Source HTML: `VolumeActions-DeleteJournal.html`_
