...
The title of the script. This string will be displayed in the script chooser
  (together with the

[**Description**](Description.md)

) and
  in the top bar of the MyDefrag window. If a script does not
  have a title then it will not be listed in the script chooser.
