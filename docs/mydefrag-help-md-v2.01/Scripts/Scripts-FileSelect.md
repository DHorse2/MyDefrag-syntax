...
The "FileSelect" keyword is the beginning of a FileSelect-FileActions-FileEnd structure, and is used inside the [![ \* ](../img/Bullit.gif) **VolumeActions**](Scripts-VolumeActions.md) to select one or more items (files, directories) with the [![ \* ](../img/Bullit.gif) **FileBoolean**](Scripts-FileBoolean.md), create a zone for those items, and then perform the [![ \* ](../img/Bullit.gif) **FileActions**](Scripts-FileActions.md) on the items.
...
[![ \* ](../img/Bullit.gif) **FileBoolean**](Scripts-FileBoolean.md)  
[![ \* ](../img/Bullit.gif) **FileActions**](Scripts-FileActions.md)  
[![ \* ](../img/Bullit.gif) **Scripts**](../Manual/Manual-Scripts.md)

---

_Source HTML: `Scripts-FileSelect.html`_
