...
- This function is intended to be used together with the [![ \* ](../img/Bullit.gif) **PlaceNtfsSystemFiles**](../FileActions/FileActions-PlaceNtfsSystemFiles.md) fileaction.
...
_Source HTML: `FileBoolean-SelectNtfsSystemFiles.html`_
