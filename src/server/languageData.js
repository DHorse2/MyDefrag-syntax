'use strict';
// languageData.js
//#region KEYWORDS, KEYWORDS_MAP, KEYWORDS_BY_PARENT
...
const KEYWORDS_MAP = new Map(KEYWORDS.map(k => [k.text, k]));
...
//#endregion
// ─────────────────────────────────────────────────────────────────────────────────
//#region Parent functionality (not used at the moment)
...
//#endregion
// ─────────────────────────────────────────────────────────────────────────────────
//#region PREDEFINED_IDENT identifiers or variables.
...
//#endregion
// ─────────────────────────────────────────────────────────────────────────────────
//#region KEYWORDS_SETTINGS
// ─────────────────────────────────────────────────────────────────────────────────
// Script/runtime/UI settings that are parsed by Parser.isSetting().
//
// Keep this list lowercase because tokenizer keyword values are normalized to lowercase.
// This keeps Parser.isSetting() readable and avoids burying language data inside parser code.
const KEYWORDS_SETTINGS = Object.freeze([
    'maxruntime',
    'message',
    'language',
    'title',
    ...
    // These are already handled elsewhere in fragment/backward logic.
    // Keep them here if they should parse as normal setting statements too.
    'setvariabledefault',
    'setvariableifempty',
]);

// Fast lookup for Parser.isSetting().
const KEYWORDS_SETTINGS_SET = new Set(KEYWORDS_SETTINGS);
//#endregion
// ─────────────────────────────────────────────────────────────────────────────────
