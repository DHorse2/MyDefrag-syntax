...
This setting controls what MyDefrag will do when it detects that it is already running. The default setting is to "ask".
...
_Source HTML: `Settings-OtherInstances.html`_
