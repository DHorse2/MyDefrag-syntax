...
<!-- markdownlint-disable MD013 MD046 MD056 MD060 -->
<!-- markdownlint-disable MD051 -->
## Table of Contents

- [Find By Topic](#find-by-topic)
- [Surfaces and Modes](#surfaces-and-modes)
  - [Codex](#codex)
  - [Codex Pricing](#codex-pricing)
  - [Feature Maturity](#feature-maturity)
  - [Quickstart](#quickstart)
- [Execution Model and Workflows](#execution-model-and-workflows)
  - [Best practices](#best-practices)
  - [Example workflows](#example-workflows)
  - [Prompting](#prompting)
  - [Speed](#speed)
- [Approvals, Sandboxing, and Security](#approvals-sandboxing-and-security)
  - [Codex Security FAQ](#codex-security-faq)
  - [Codex Security plugin changelog](#codex-security-plugin-changelog)
  - [Codex Security plugin quickstart](#codex-security-plugin-quickstart)
  - [Codex Security setup](#codex-security-setup)
  - [Export and track security findings](#export-and-track-security-findings)
  - [Fix and verify security findings](#fix-and-verify-security-findings)
  - [Improving the threat model](#improving-the-threat-model)
  - [Review code changes for security](#review-code-changes-for-security)
  - [Run a Codex Security scan](#run-a-codex-security-scan)
  - [Run a deep security scan](#run-a-deep-security-scan)
  - [Triage a backlog](#triage-a-backlog)
  - [Agent approvals & security](#agent-approvals-security)
  - [Cyber Safety](#cyber-safety)
  - [Sandbox](#sandbox)
- [Configuration, Authentication, and Models](#configuration-authentication-and-models)
...
- [CLI, IDE, App, and Cloud Behavior](#cli-ide-app-and-cloud-behavior)
  - [CLI command reference](#cli-command-reference)
  - [Agent internet access](#agent-internet-access)
  ...
  - [Codex Chrome extension](#codex-chrome-extension)
  - [Codex CLI features](#codex-cli-features)
  - [Codex IDE extension commands](#codex-ide-extension-commands)
  - [Codex IDE extension features](#codex-ide-extension-features)
  - [Codex IDE extension settings](#codex-ide-extension-settings)
  - [Codex IDE extension slash commands](#codex-ide-extension-slash-commands)
  - [Computer Use - CLI IDE App and Cloud Behavior](#computer-use---cli-ide-app-and-cloud-behavior)
  - [In-app browser - CLI IDE App and Cloud Behavior](#in-app-browser---cli-ide-app-and-cloud-behavior)
  - [Local environments](#local-environments)
  - [Review](#review)
  - [Slash commands in Codex CLI](#slash-commands-in-codex-cli)
  - [Troubleshooting - CLI IDE App and Cloud Behavior](#troubleshooting---cli-ide-app-and-cloud-behavior)
  ...
  - [Codex web](#codex-web)
- [Customization, Skills, Rules, MCP, and Integrations](#customization-skills-rules-mcp-and-integrations)
  - [Agent Skills](#agent-skills)
  - [Codex code review in GitHub](#codex-code-review-in-github)
  - [Custom instructions with AGENTS.md](#custom-instructions-with-agentsmd)
  - [Custom Prompts](#custom-prompts)
  - [Customization](#customization)
  - [Model Context Protocol](#model-context-protocol)
  - [Rules](#rules)
  - [Use Codex in Linear](#use-codex-in-linear)
  - [Use Codex in Slack](#use-codex-in-slack)
- [Noninteractive and Programmatic Interfaces](#noninteractive-and-programmatic-interfaces)
  - [Codex App Server](#codex-app-server)
  - [Codex GitHub Action](#codex-github-action)
  - [Codex SDK](#codex-sdk)
  - [Non-interactive mode](#non-interactive-mode)
  - [Use Codex with the Agents SDK](#use-codex-with-the-agents-sdk)
- [Platform, Enterprise, and Caveats](#platform-enterprise-and-caveats)
  ...
  - [Subagents - Platform Enterprise and Caveats](#subagents---platform-enterprise-and-caveats)
  - [Build plugins](#build-plugins)
  - [Chronicle](#chronicle)
  - [Codex Security](#codex-security)
  - [Glossary](#glossary)
  - [Hooks - Platform Enterprise and Caveats](#hooks---platform-enterprise-and-caveats)
  - [Import to Codex](#import-to-codex)
  - [Memories - Platform Enterprise and Caveats](#memories---platform-enterprise-and-caveats)
  - [Open Source](#open-source)
  - [Permissions](#permissions)
  - [Plugins - Platform Enterprise and Caveats](#plugins---platform-enterprise-and-caveats)
  - [Record & Replay](#record-replay)
  - [Remote connections](#remote-connections)
  - [Sites](#sites)
  - [Subagents - Platform Enterprise and Caveats (2)](#subagents---platform-enterprise-and-caveats-2)
  - [Use Codex with Amazon Bedrock](#use-codex-with-amazon-bedrock)
...
- `config.toml`, `.codex/config.toml`, `auth.json`, `ChatGPT sign-in`, `API key login`, `models`, `providers`, `model_reasoning_effort`: [Configuration, Authentication, and Models](#configuration-authentication-and-models)
- `codex exec`, `codex cloud`, `codex mcp`, `worktrees`, `automations`, `cloud environments`, `internet access`: [CLI, IDE, App, and Cloud Behavior](#cli-ide-app-and-cloud-behavior)
- `AGENTS.md`, `skills`, `rules`, `custom prompts`, `MCP`, `GitHub integration`, `Slack integration`: [Customization, Skills, Rules, MCP, and Integrations](#customization-skills-rules-mcp-and-integrations)
- `sdk`, `noninteractive`, `app-server`, `github-action`, `CI`, `auth in CI`: [Noninteractive and Programmatic Interfaces](#noninteractive-and-programmatic-interfaces)
...
If you are new to Codex or coding agents in general, this guide will help you get better results faster. It covers the core habits that make Codex more effective across the [CLI](/codex/cli), [IDE extension](/codex/ide), and the [Codex app](/codex/app), from prompting and planning to validation, MCP, skills, and automations.
...
**Use a PLANS.md template:** For more advanced workflows, you can configure Codex to follow a `PLANS.md` or execution-plan template for longer-running or multistep work. For more detail, see the [execution plans guide](/cookbook/articles/codex_exec_plans).
...
Codex can do this loop for you, but only if it knows what a good loop looks like. That guidance can come from either the prompt or `AGENTS.md`.
...
1. Attach the files (optional) and prompt:
...
sign in with ChatGPT. With an API key, Codex uses standard API pricing instead, and you can't use Fast mode credits.
...
Initial scan setup is automatic and thorough. This can take a few hours. Donâ€™t
...
Over recent months, weâ€™ve seen meaningful gains in model performance on cybersecurity tasks, benefiting both developers and security professionals. As our models improve at cybersecurity-related tasks like vulnerability discovery, weâ€™re taking a precautionary approach: expanding protections and enforcement to support legitimate research while slowing misuse.

Cyber capabilities are inherently dual-use. The same knowledge and techniques that underpin important defensive work â€” penetration testing, vulnerability research, high-scale scanning, malware analysis, and threat intelligence â€” can also enable real-world harm.
...
Security researchers and teams who may need access to even more cyber-capable or permissive models to accelerate legitimate defensive work can express interest in our [invite-only programâ](https://docs.google.com/forms/d/e/1FAIpQLSea_ptovrS3xZeZ9FoZFkKtEJFWGxNrZb1c52GW4BVjB2KVNA/viewform?usp=header). Users with trusted access must still abide by our [Usage Policiesâ](https://openai.com/policies/usage-policies/) and [Terms of Useâ](https://openai.com/policies/row-terms-of-use/).
...
#### Automations - Codex app commands
...
#### Automations - Codex app features
...
#### Thread automations - Codex app features
...
When you see prompts like â€œapprove onceâ€ or â€œapprove for this session,â€ you are
...
#### Keyboard shortcuts - Codex app settings
...
#### Computer Use - Codex app settings
...
#### Memories - Codex Chrome extension
...
#### Feature flags - Codex CLI features
...
#### Image generation - Codex CLI features
...
Add `--attempts` (1â€“4) to request best-of-N runs when you want Codex cloud to generate more than one solution. For example, `codex cloud exec --env ENV_ID --attempts 3 "Summarize open bugs"`.

Environment IDs come from your Codex cloud configurationâ€”use `codex cloud` and press Ctrl+O to choose an environment or the web dashboard to confirm the exact value. Authentication follows your existing CLI login, and the command exits non-zero if submission fails so you can wire it into scripts or CI.

#### Slash commands - Codex CLI features
...
Connect Codex to more tools by configuring Model Context Protocol servers. Add STDIO or streaming HTTP servers in `~/.codex/config.toml`, or manage them with the `codex mcp` CLI commandsâ€”Codex launches them automatically when a session starts and exposes their tools next to the built-ins. You can even run Codex itself as an MCP server when you need it inside another agent.
...
#### Web search - Codex IDE extension features
...
#### Image generation - Codex IDE extension features
...
#### Use a slash command - Codex IDE extension slash commands

1. In the Codex chat input, type `/`.
2. Select a command from the list, or keep typing to filter (for example, `/status`).
3. Press **Enter**.

#### Available slash commands - Codex IDE extension slash commands
...
### Computer Use - CLI IDE App and Cloud Behavior
...
### In-app browser - CLI IDE App and Cloud Behavior
...
follow-up message that makes your intent explicit, for example â€œAddress the
inline comments and keep the scope minimal.â€
...
happens, it can look like the pane is showing â€œthe same file twiceâ€ across
...
| `/clear`                 | Clear the terminal and start a fresh chat.                      | Reset the visible UI and conversation together when you want a fresh start.                                |
...
| `/experimental`              | Toggle experimental features.                                   | Enable optional features such as subagents from the CLI.                                                   |
...
| `/fast`                                          | Toggle a Fast service tier when the model catalog exposes one.  | Turn the current model's Fast tier on or off, or check whether the thread is using it.                     |
...
| `/goal`                                   | Set, pause, resume, view, or clear a task goal.                 | Give Codex a persistent target to track while a larger task runs.                                          |
...
| `/side`, `/btw`                         | Start an ephemeral side conversation.                           | Ask a focused follow-up without disrupting the main thread's transcript.                                   |
...
### Troubleshooting - CLI IDE App and Cloud Behavior
...
The Codex app on Windows supports a native [Windows sandbox](/codex/windows#windows-sandbox) when the agent runs in PowerShell, and uses Linux sandboxing when you run the agent in Windows Subsystem for Linux 2 (WSL2). To apply sandbox protections in either mode, set sandbox permissions to **Default permissions** in the Composer before sending messages to Codex.
...
#### Integrated terminal - Windows app
...
1. Work exclusively on the worktree. This path works best when you can verify changes directly on the worktree, for example because you have dependencies and tools installed using a [local environment setup script](/codex/app/local-environments).
...
Codex includes an initial list of available skills in context so it can choose the right skill for a task. To avoid crowding out the rest of the prompt, this list uses at most 2% of the modelâ€™s context window, or 8,000 characters when the context window is unknown. If many skills are installed, Codex shortens skill descriptions first. For large skill sets, Codex may omit some skills from the initial list and show a warning.
...
2. Wait for Codex to react (ðŸ‘€) and post a review.
...
(for example, â€œTreat typos in docs as P1.â€).
...
1. Create `~/.codex/AGENTS.md` with reusable preferences:
...
1. Run Codex anywhere to confirm it loads the file:
...
#### Next steps - Custom instructions with AGENTSmd
...
1. Create `~/.codex/prompts/draftpr.md` with reusable guidance:
...
1. Restart Codex so it loads the new prompt (restart your CLI session, and reload the IDE extension if you are using it).
...
After editing prompt files, restart Codex or open a new chat so the updates load. Codex ignores non-Markdown files in the prompt's directory.
...
They are often the best fit for reusable workflows because they support richer instructions, scripts, and references while staying reusable across tasks.
...
2. Group into separate commits: feat â†’ test â†’ docs â†’ refactor â†’ chore.
...
- The task runs against the default branch of the first repository listed in that environmentâ€™s repo map. Update the repo map in Codex if you need a different default or more repositories.
...
#### How Codex chooses an environment and repo - Use Codex in Slack
...
#### Data usage, privacy, and security - Use Codex in Slack
...
#### Tips and troubleshooting - Use Codex in Slack
...
```json
{ "id": 10, "result": { "thread": { "id": "the_123" } } }
```
...
#### Prerequisites - Codex GitHub Action
...
#### Troubleshooting - Codex GitHub Action
...
#### Permissions and safety - Noninteractive mode
...
```json
{
  "structuredContent": {
    ...
    "content": "`ls -lah` (or `ls -alh`) â€” long listing, includes dotfiles, human-readable sizes."
  },
  "content": [
    {
      "type": "text",
      "text": "`ls -lah` (or `ls -alh`) â€” long listing, includes dotfiles, human-readable sizes."
    }
  ]
}
```
...
Letâ€™s start with a scoped example that uses Codex MCP to ship a small browser game. The workflow relies on two agents:
...
If the Codex Local toggle is off, users who attempt to use the Codex app, CLI, or IDE will see the following error: â€œ403 - Unauthorized. Contact your ChatGPT administrator for access.â€
...
### Subagents - Platform Enterprise and Caveats
...
Codex, those memories can help it understand what youâ€™ve been working on with
...
Weâ€™ve designed Chronicle to reduce the amount of context you have to restate
when you work with Codex. By using recent screen context to improve memory
building, Chronicle can help Codex understand what youâ€™re referring to, identify
the right source to use, and pick up on the tools and workflows you rely on.

#### Use whatâ€™s on screen
...
Donâ€™t use Chronicle to record meetings or communications with others without
...
files to remove the information youâ€™d like to remove. You should not manually
...
### Hooks - Platform Enterprise and Caveats
...
### Memories - Platform Enterprise and Caveats
...
#### Configuration - Memories  Platform Enterprise and Caveats
...
### Plugins - Platform Enterprise and Caveats
...
#### Before you start - Record  Replay
...
1. Confirm you can SSH to the host from the machine running the Codex App.

   ```bash
   ssh devbox
   ```

1. Install and authenticate Codex on the remote host.
...
1. In the Codex App, open **Settings > Connections**, add or enable the SSH
...
### Subagents - Platform Enterprise and Caveats (2)
...
#### How it works - Use Codex with Amazon Bedrock
...
#### Before you start - Use Codex with Amazon Bedrock
...
1. AWS Management Console credentials.

   ```shell
   aws login
   ```

1. AWS SSO or a named profile.
...
1. Federated identity configured with `credential_process`. For corporate SSO or
...
- Feature is currently limited to only specific regions. Check
  ...
  â€  Local plugin bundles are supported when their capabilities do
