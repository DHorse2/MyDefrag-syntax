...
- The [![ \* ](../img/Bullit.gif) **FastFill**](FileActions-FastFill.md) and [![ \* ](../img/Bullit.gif) **MoveDownFill**](FileActions-MoveDownFill.md) fileactions will only move files down, never up, so files that are in a DoNotVacate gap will be left in the gap.

### Syntax

|                                                                      |
|----------------------------------------------------------------------|
| `AddGap(`[`NUMBER`](../Scripts/Scripts-NUMBER.md)` [, DoNotVacate])` |
...
[![ \* ](../img/Bullit.gif) **MakeGap**](../VolumeActions/VolumeActions-MakeGap.md)  
[![ \* ](../img/Bullit.gif) **FileActions**](../Scripts/Scripts-FileActions.md)

---

_Source HTML: `FileActions-AddGap.html`_
