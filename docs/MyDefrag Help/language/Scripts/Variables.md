...
The number of files and directories, fragmented and unfragmented. The percentages are the same number, but as the percentage of the total files and directories on the volume. Variable Units Description
...
The size of files without sparse space, in other words the space that files are actually occupying on disk. The percentages are the same number, but as the percentage of the total files and directories on the volume. Variable Units Description
...
The size of files including sparse space. This is the size of files normally reported by Windows. It includes the space for empty (unused) blocks of data (in the files) that do not occupy space on disk. The percentages are the same number, but as the percentage of the total files and directories on the volume. Variable Units Description
...
The number of files and directories in the zone, fragmented and unfragmented. The percentages are the same number, but as the percentage of the total files and directories on the volume. Variable Units Description
...
The size of files in the zone without sparse space, in other words the space that files are actually occupying on disk. The percentages are the same number, but as the percentage of the total files and directories on the volume. Variable Units Description
...
Gaps by size
Statistics about the size of the gaps on the volume. The percentages are the same number, but as the percentage of the total gaps on the volume. Variable Units Description
...
Unmovable items
MyDefrag initially treats all files as movable, and will only mark an item as unmovable after the Microsoft defragmentation API has refused to move it. Variable Units Description
...
Bad cluster list
Windows will add disk clusters to the "$BadClus:$Bad:$DATA" system file when it detects a hardware error. If the list begins to grow then you should immediately replace the disk. Variable Units Description
...
Memory usage
Statistics about the memory in use by the program. Variable Units Description
