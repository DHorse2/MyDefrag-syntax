...
- If your computer becomes unresponsive while running MyDefrag (especially the MyDefrag display) then try changing the [![ \* ](img/Bullit.gif) **Slowdown**](../Settings/Settings-Slowdown.md) and/or [![ \* ](img/Bullit.gif) **ProcessPriority**](../Settings/Settings-ProcessPriority.md) settings in your "Settings.MyD" file to make MyDefrag use less resources.  
  **Note:** It is normal for your computer to be unresponsive while the \$MFT is being moved. This is caused by something inside Windows itself, not MyDefrag.
...
_Source HTML: `FAQ/FAQUsing-MyDefragIsVerySlowWhatSpeedCanIExpect.html`_
