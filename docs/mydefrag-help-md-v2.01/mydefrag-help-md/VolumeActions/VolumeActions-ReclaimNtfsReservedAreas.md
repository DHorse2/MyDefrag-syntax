...
- The NTFS system files are skipped and will stay in the NTFS reserved area. See the [![ \* ](../img/Bullit.gif) **SelectNtfsSystemFiles**](../FileBoolean/FileBoolean-SelectNtfsSystemFiles.md) filebooelan for the list.

### Syntax

|                                                                            |
|----------------------------------------------------------------------------|
| `ReclaimNtfsReservedAreas(`[`SETTINGS`](../Scripts/Scripts-Settings.md)`)` |
...
[![ \* ](../img/Bullit.gif) **PlaceNtfsSystemFiles**](../FileActions/FileActions-PlaceNtfsSystemFiles.md)  
[![ \* ](../img/Bullit.gif) **DismountVolume**](VolumeActions-DismountVolume.md)  
...
_Source HTML: `VolumeActions-ReclaimNtfsReservedAreas.html`_
